...
2. DIVISOR: Identifica 'SECCIÓN AVISOS VARIOS' como el único 'sectiontitle'.
3. BLOQUE INFERIOR: Solo después del divisor, procesa las columnas de abajo.

REGLAS DE CLASIFICACIÓN:
- 'sectiontitle': Solo títulos que cruzan las 3 columnas con interletrado ancho.  Texto en MAYÚSCULAS con mucho espacio entre cada letra (interletrado) y un espacio en blanco significativo arriba y abajo (ej: NOTIFICACIONES CATASTRALES)
- 'entrietitle': Encabezados de decretos o nombres de entidades, Títulos en MAYÚSCULAS o Negrita que inician un nuevo bloque de información y tienen un espacio en blanco superior que los separa del texto anterior.
